...
python -u train_single.py \
        ...
        -gpuid=0 \
        -pre_word_vecs_enc=../data/processed_300_50_30.glove.enc.pt \
        -pre_word_vecs_dec=../data/processed_300_50_30.glove.dec.pt \
        -batch_size=32 \
        -valid_steps=3000 \
        -valid_batch_size=16 \
        -train_steps=45000 \
...
python -u train_single.py \
        ...
        -lambda_question=0.5 \
        -lambda_answer=-1 \
        -data=../data/processed_300_50_30 \
        -save_model=../data/model/0513_model_bs32_300_50_30 \
        -save_checkpoint_steps=3000 \
        -gpuid=0 \
        -pre_word_vecs_enc=../data/processed_300_50_30.glove.enc.pt \
        -pre_word_vecs_dec=../data/processed_300_50_30.glove.dec.pt \
